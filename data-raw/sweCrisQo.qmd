...
```{r}
source(file = "C:/Repos/swecris/data-raw/customFunction.R")
```
...
```{r echo=TRUE,out.width="50%",fig.cap="Data-driven flowchart (keys)."}
include_graphics("C:/Repos/swecris/analytic-img/DataDriven-Flowchart.png")
```

```{r echo=TRUE,out.width="50%",fig.cap="Entity/Relationship (ER) diagram."}
include_graphics("C:/Repos/swecris/analytic-img/entityGraph.png")
```

```{r echo=TRUE,out.width="80%"}
db_connections <- read.csv2(file = "C:/Repos/swecris/data-raw/alluvial-graph-data.csv",header = T)
# Plot. 
...
```{r echo=TRUE, fig.cap="Pareto chart for missing values (counts and proportions) in Swecris"}
...
```{r fig.cap="Comparison of results",fig.align='center'}
...
```{r echo=TRUE,results='hide', fig.cap="Primary Researchers in sweCris with projects > 10"}
# Summarize.
...
```{r echo=TRUE,fig.cap="Pareto chart for missing values (counts and proportions) in the reduced CASE dataset."}
...
```{r echo=TRUE,fig.cap="Venn diagram showing project overlap based on Primary Researcher Area 1 (Grey) = sweCris. Area 2 (Red) = Case"}
...
```{r echo=TRUE,fig.cap="Venn diagram showing project overlap based on Id, Title, and Primary Researcher."}
