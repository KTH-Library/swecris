...
- Added support for new fields (updatedDate, loadedDate) returned for
  projects
- Updated norwegian list (Nov 27, 2023) and embedded data for norwegian
  list
...
- Added functions for parsing SweCRIS export fields for InvolvedPeople
  and Scbs
- Added updated swecris_kth data which corrects some earlier outdated
  fields

## swecris 0.1.3

- Added functions for searching, getting data for specific project and
  related persons and SCB codes
- Refactored functions that used the older “betasearch” API to use new
  API routes
...
- Added support for Swedish, Norwegian, Finnish and Danish lists with
  authoritative publication sources

## swecris 0.1

- Added basic support for some routes in the API described at
  <https://swecris-api.vr.se/index.html>
